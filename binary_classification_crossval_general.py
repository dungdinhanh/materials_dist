...
parser.add_argument('--input', type=str, default="hdpe_ldpe_original.csv", help="Input file")
parser.add_argument('--aug', type=str, default='rep', help="augmentation method")
parser.add_argument('--pp', type=int, default=0, help="pp or not")
...
if __name__ == '__main__':
    ...
    for i in range(n_fold):
        ...
        if args.aug == 'rep':
            ...
            if args.input == 'hdpe_ldpe_original.csv':
                data = mixup_aug(data, 4, 0.5)
            else:
                data = mixup_aug(data, 4, 0.5, 'hdpe', 'pp')
        # exit(0)
        # exit(0)
